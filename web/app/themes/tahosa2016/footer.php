	...
	<footer id="footer" class="<?php extra_footer_classes(); ?>">
		...
		<div id="footer-bottom">
			<div class="container">
				...
				<!-- Footer Info -->
				<p id="footer-info">&copy; <?php echo date( 'Y' ); ?> Tahosa Lodge | Need help? <a href="mailto:help@tahosalodge.org">Email Us</a> | Site by <a href="https://mckernan.in">Kevin McKernan</a> </p>
